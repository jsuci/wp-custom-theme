...
<main aria-label="Main content" class="main-content">
    <h1 class="site-title">Software Guides and How To's</h1>
        ...
        <div class="lg:w-9/12">
            <?php while (have_posts()) : the_post(); ?>
                <article aria-labelledby="post-title-<?php the_ID(); ?>" class="bg-slate-700 p-6 rounded-lg mb-6">
                    <header class="mb-6">
                        <h2 id="post-title-<?php the_ID(); ?>" class="text-4xl/snug mb-6 post-title">
                    ...
                    <div class="article-content">
                        <div class="thumbnail-excerpt">
                            <img src="<?php the_field('post_thumbnail') ?>" alt="<?php the_field("post_title") ?> Thumbnail Image" />
                            <div class="post-excerpt">
                                <?php
                                $desc = get_field("post_description");
                                $excerpt = substr($desc, 0, 350);
                                echo $excerpt . " ...";
                                ?>
                            </div>
                        </div>
